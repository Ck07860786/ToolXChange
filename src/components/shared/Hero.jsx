...
export function Hero() {
    ...
    <div
      ...
      <div className="px-4 py-10 md:py-20">
        <h1
         ...
         {
  "Share More. Spend Less. Build Better."
    .split(" ")
    .map((word, index) => (
      <motion.span
        key={index}
        ...
        className={`mr-2 inline-block ${
          word.includes("More") || word.includes("Less") ? "text-blue-500 dark:text-purple-400" : ""
        }`}
      >
        {word}
      </motion.span>
  ...
  Stop buying tools you rarely use. Share with neighbors, save money, and turn your ideas into reality.
        </motion.p>
        <motion.div
          initial={{
            opacity: 0,
        ...
        <motion.div
          ...
          <div
            className="w-full overflow-hidden rounded-xl border bg-white border-gray-300 dark:border-gray-700">
            <Image
              src={HroImage}
              alt="Landing page preview"
              className="aspect-[16/9] mt-10 h-auto w-full object-cover"
              height={1000}
              width={1000} />
          </div>
        </motion.div>
